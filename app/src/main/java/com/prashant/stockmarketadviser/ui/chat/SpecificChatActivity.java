...
import com.prashant.stockmarketadviser.firebase.MyFirebaseMessagingService;
...
public class SpecificChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (userModel != null && senderModel != null) {
            ...
            bind.actionBarTitle.setOnClickListener(new View.OnClickListener() {
                @Override
        ...
        bind.sendBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (msg.equals("")){
                    ...
                    Constant.chatDB.child(senderRoom).child("message").push().setValue(chatModel).addOnCompleteListener(new OnCompleteListener<Void>() {
                        @Override
                        public void onComplete(@NonNull Task<Void> task) {

                            if (task.isSuccessful()) {
                                Constant.chatDB.child(receiverRoom).child("message").push().setValue(chatModel).addOnCompleteListener(new OnCompleteListener<Void>() {
                                    @Override
                                    public void onComplete(@NonNull Task<Void> task) {
                                        if (task.isSuccessful()){
                                    ...
                                    public void onFailure(@NonNull Exception e) {
                                        VUtil.showErrorToast(SpecificChatActivity.this, e.getMessage());
                                    }
                                });
                            }
